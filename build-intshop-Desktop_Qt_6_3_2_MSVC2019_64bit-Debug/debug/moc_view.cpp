...
static const qt_meta_stringdata_View_t qt_meta_stringdata_View = {
    {
        ...
        QT_MOC_LITERAL(27, 23),  // "on_categories_activated"
        QT_MOC_LITERAL(51, 5),  // "index"
        QT_MOC_LITERAL(57, 15)   // "on_empl_clicked"
    },
    "View",
    "back",
    "",
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_categories_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->on_empl_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (View::*)();
            if (_t _q_method = &View::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<View, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
