...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Edit_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Edit_t qt_meta_stringdata_Edit = {
    {
        QT_MOC_LITERAL(0, 4),  // "Edit"
        QT_MOC_LITERAL(5, 4),  // "back"
        QT_MOC_LITERAL(10, 0),  // ""
        QT_MOC_LITERAL(11, 15),  // "on_back_clicked"
        QT_MOC_LITERAL(27, 19),  // "on_editEl_activated"
        QT_MOC_LITERAL(47, 5),  // "index"
        QT_MOC_LITERAL(53, 16)   // "on_editB_clicked"
    },
    "Edit",
    "back",
    "",
...
void Edit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_editEl_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->on_editB_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Edit::*)();
            if (_t _q_method = &Edit::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Edit::staticMetaObject = { {
    ...
    qt_meta_stringdata_Edit.offsetsAndSizes,
    qt_meta_data_Edit,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Edit_t
, QtPrivate::TypeAndForceComplete<Edit, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
