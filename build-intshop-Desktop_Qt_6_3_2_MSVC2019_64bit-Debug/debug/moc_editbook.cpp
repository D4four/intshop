...
static const qt_meta_stringdata_EditBook_t qt_meta_stringdata_EditBook = {
    {
        ...
        QT_MOC_LITERAL(31, 15)   // "on_save_clicked"
    },
    "EditBook",
    "back",
    "",
...
void EditBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (EditBook::*)();
            if (_t _q_method = &EditBook::back; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<EditBook, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
